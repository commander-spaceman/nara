...
export { loadBoundsMetadata, getAnimationBounds } from "./bounds/bounds-metadata";
...
export { BoundsEngine } from "./bounds/bounds-engine";
export type { BoundsMode } from "./bounds/bounds-engine";
